    ...
    <Stack mt={2}>
      <TableContainer>
        <Table aria-label="simple table">
          ...
          {!addToBasket || <TableBody></TableBody>}
          {addToBasket && (
            <TableBody>
              {addToBasket.map((row: any, index: number) => (
                <TableRow
                  key={index}
                ...
                >
                  ...
                  <TableCell align="center">
                    ...
                    >
                      <Typography
                        onClick={() => {
                          const newBasket = addToBasket.map((element: any) => {
                      ...
                      >
                        <Add
                          onClick={() => {
                            const newBasket = addToBasket.map(
                              (element: any) => {
                                if (element.productId == row.productId) {
                                  element.orderQty += 1;
                                  return element;
                  ...
                  <TableCell align="center">
                    <Typography
                      onClick={() => {
                        const newBasket = addToBasket.filter(
